...
var lol;
class LOLThread extends React.Component{
    constructor(props){
        super(props);
        lol = Db.getDatabase().ref("Talks/lol/"+NavStore.threadId);
        this.state = {
            cmnt: '',
            title: "",
            feeds: []
    ...
    createFeed(){
        var feed = Db.getDatabase().ref("Talks/lol/" + NavStore.threadId + "/Feeds");
